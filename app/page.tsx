  ...
  return (
    <WalletProvider>
      <div className="min-h-screen flex flex-col">
        <header className="p-2 sm:p-4 border-b-4 border-retro-green">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            {isMobile ? (
              <div className="relative" ref={menuRef}>
                {isMobileMenuOpen && (
                  <div 
                    className="absolute right-0 top-full mt-2 pixel-border bg-retro-bg z-50"
                    style={{
                  ...
                  >
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 transition ${
                        currentView === 'lobby' 
                          ...
                          : 'hover:bg-retro-green hover:text-retro-bg'
                      }`}
                      style={{
                    ...
                    <div className="px-4 py-3" style={{ borderTop: '2px solid #00ff00' }}>
                      <WalletConnect />
                    </div>
                  </div>
                )}
